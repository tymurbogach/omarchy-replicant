...
suites=(test-core.sh test-settings.sh test-cli.sh test-bulk.sh test-journey.sh test-usability.sh test-schema.sh test-v3schema.sh test-bootstrap.sh test-crypto.sh test-state.sh test-save.sh test-leaks.sh test-interruptions.sh test-migration.sh test-modules.sh)
logs=$(mktemp -d)
declare -A pid=()
